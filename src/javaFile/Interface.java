...
public class Interface extends javax.swing.JFrame {
     ...
     */
    public Interface() {
    	this.setBounds(300,50,1400,1051);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Developer", "Programmer", "Student" }));
    ...
    public void exit(String name, String inst, String prof) {
    	this.dispose();
    	Console console = new Console(name,inst,prof);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                intfc.setBounds(300,50,1400,1051);
